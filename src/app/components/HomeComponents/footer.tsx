...
import { FaYoutube, FaLinkedin, FaTiktok, FaFacebook, FaWhatsapp } from "react-icons/fa"; // Social icons
import { FaArrowCircleRight, FaRegCopyright } from "react-icons/fa"; // Other icons
  ...
  return (
    <main className="bg-neutral-900">
        ...
        <div className="sm:pl-[5%] md:pl-[10%] lg:pl-0 w-full gap-y-9 pt-3 sm:pb-6 flex sm:flex-col lg:flex-row justify-evenly text-white">
          <div className="w-[200px]">
            ...
            <ul>
              ...
              <li className="mt-3 cursor-pointer py-1 border flex justify-center">
                ...
                />
                <FaArrowCircleRight className="text-xl sm:hidden md:block" />
              </li>
            </ul>
          </div>
          <div className="w-[200px]">
          ...
          <div>
            ...
            <ul className="list-none flex gap-x-3">
              <li>
                <Link
                  href="https://youtube.com/@muzaffaritacademy?si=ViSjim7Zs95fDwXQ"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaYoutube className="text-3xl mr-2 transition duration-200 ease-out hover:scale-105 hover:ease-in" />
                </Link>
              </li>
              <li>
                <Link
                  href="https://www.linkedin.com/in/muzaffar-ali-0b3939315?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaLinkedin className="text-3xl mr-2 transition duration-200 ease-out hover:scale-105 hover:ease-in" />
                </Link>
              </li>
              <li>
                <Link
                  href="https://www.tiktok.com/@_muzaffar_ali_?_t=8qCq6QIr05a&_r=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaTiktok className="text-3xl mr-2 transition duration-200 ease-out hover:scale-105 hover:ease-in" />
                </Link>
              </li>
              <li>
                <Link
                  href="https://web.facebook.com/profile.php?id=100093557110026"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaFacebook className="text-3xl mr-2 transition duration-200 ease-out hover:scale-105 hover:ease-in" />
                </Link>
              </li>
              <li>
                <Link
                  href="https://chat.whatsapp.com/EJ4MB6rr9Jm6Nlj4YYMrH1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="text-3xl mr-2 transition duration-200 ease-out hover:scale-105 hover:ease-in" />
                </Link>
              </li>
            </ul>
          </div>
      ...
      <p className="text-white text-center text-sm pb-4">
        <FaRegCopyright className="text-lg mr-3" />
